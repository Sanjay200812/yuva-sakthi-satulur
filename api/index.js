...
var SYSTEM_INSTRUCTION = `You are a financial screenshot OCR and security analysis assistant.
...
var mockGeminiExtraction = null;
async function analyzePaymentScreenshotWithGemini(imageBuffer, mimeType = "image/jpeg") {
...
function performDeterministicComparison(input) {
  ...
  const hasFatalFailure = reasonCodes.includes("MISSING_PAYMENT_REFERENCE") || reasonCodes.includes("DUPLICATE_PAYMENT_REFERENCE") || reasonCodes.includes("INVALID_PAYMENT_REFERENCE") || reasonCodes.includes("INVALID_RRN") || reasonCodes.includes("INVALID_UTR") || reasonCodes.includes("DUPLICATE_RRN") || reasonCodes.includes("DUPLICATE_UTR") || reasonCodes.includes("DUPLICATE_SCREENSHOT") || reasonCodes.includes("STATUS_NOT_SUCCESS") || reasonCodes.includes("AMOUNT_MISMATCH") || reasonCodes.includes("MISSING_AMOUNT") || reasonCodes.includes("MISSING_RRN") || reasonCodes.includes("WRONG_PAYEE") || reasonCodes.includes("TAMPERING_RISK") || reasonCodes.includes("LOW_OCR_CONFIDENCE") || reasonCodes.includes("LOW_CONFIDENCE") || reasonCodes.includes("INVALID_PAYMENT_SCREEN") || reasonCodes.includes("PAYMENT_SESSION_EXPIRED") || reasonCodes.includes("AI_UNAVAILABLE") || riskScore >= 50;
  if (hasFatalFailure) {
