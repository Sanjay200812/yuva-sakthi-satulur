        ...
        >
          ...
          <div className="py-4 space-y-3">
            ...
            <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-purple-950/40 border border-purple-500/20 text-[11px]">
              <span className="text-slate-300 flex items-center gap-1">
                ...
                Gateway: {booking.paymentGateway || 'VyaparGateway UPI'}
              </span>
              <span className="font-mono text-emerald-400 font-semibold">
                Ref: {booking.transactionRef || 'PAID_CONFIRMED'}
              </span>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-2 max-h-36 overflow-y-auto custom-scrollbar p-2.5 bg-slate-950/90 rounded-xl border border-amber-400/30">
                {booking.ticketNumbers.map((num) => (
                  <div
                    key={num}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-amber-500/20 to-yellow-500/20 border border-amber-400/50 shadow-sm"
                  >
                    <span className="text-amber-300 font-mono text-xs font-black tracking-wider">
                      {num}
                    </span>
                    <a
                      href={`/api/coupons/${num}/download`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-1 rounded bg-amber-400 hover:bg-amber-300 text-slate-950 text-[10px] font-bold flex items-center gap-0.5 cursor-pointer"
                      title="Download PDF"
                    >
          ...
          <div className="pt-2 flex items-center justify-between text-xs">
            ...
            <div className="flex items-center gap-1 text-emerald-400 text-[11px] font-semibold">
              ...
              <span>VyaparGateway Verified</span>
            </div>
          </div>
        </div>
